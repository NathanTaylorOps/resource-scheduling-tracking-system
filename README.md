...
- **Job hazard analyses** (`JobHazardAnalysis`) record a task, its identified hazards, and the controls in place for it — the pre-task planning document a real safety program expects on file before higher-risk work starts, not an auto-generated risk assessment.
